...
object FreshnessTable {
    ...
    private val table = listOf(
        ...
        Regex("菜|菠菜|生菜|油菜|芹菜|韭菜|莴笋|上海青|小白菜|娃娃菜|油麦菜|苋菜|空心菜|茼蒿|苦菊|芥蓝|芦笋") to Triple(4, 270, null), // 叶菜
        Regex("番茄|西红柿|圣女果|小番茄|青椒|辣椒|彩椒|甜椒|菜椒|秋葵|黄瓜|冬瓜|丝瓜|苦瓜|西葫芦|茄子") to Triple(5, 180, 3), // 茄果瓜
        Regex("胡萝卜|白萝卜|山药|南瓜|莲藕|藕|荸荠|菱角") to Triple(21, null, 14), // 根茎
        Regex("土豆|洋葱|大蒜|蒜|葱|姜|红薯|紫薯|芋头|生姜|香芋") to Triple(null, null, 60), // 葱蒜薯芋→常温
        Regex("蘑菇|香菇|金针菇|杏鲍菇|平菇|木耳|银耳|茶树菇") to Triple(5, 180, 90), // 菌菇
